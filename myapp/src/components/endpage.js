...
const Endpage = () => {
  ...
  return (
    <div>
      ...
      <div style={{marginLeft:"42%"}}><div style={{fontSize:"30px",fontWeight:"bold", textAlign:"center", width:"250px",height:"50px", backgroundColor:"skyblue"}}><a href={`tel:${phoneNumber}`}>8054199332</a></div></div>
