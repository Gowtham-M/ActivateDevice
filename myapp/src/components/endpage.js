...
const Endpage = () => {
  ...
  return (
    <div>
      ...
      <div style={{marginLeft:"42%"}}><div style={{fontSize:"30px",fontStyle:"bold", textAlign:"center", width:"250px",height:"50px", backgroundColor:"skyblue", fontWeight:"bold"}}>8054199332</div></div>
    </div>
  );
};
